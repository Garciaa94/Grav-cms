...
class __TwigTemplate_b55d2fbba3e4aae3ae48a551d202252aa5cbe6dcfbb41d0fe01b61f68870b3d4 extends \Twig\Template
{
    ...
    public function block_input($context, array $blocks = [])
    {
        ...
        if (($this->getAttribute(($context["data"] ?? null), "status", []) == "success")) {
            ...
            <div>
                <span>";
            // line 11
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.2FA_SECRET"), "html", null, true);
            ...
            <div class=\"danger\">
                <button data-hint=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.2FA_REGEN_HINT"), "html", null, true);
